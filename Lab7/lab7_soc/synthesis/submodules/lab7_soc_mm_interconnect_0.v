...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [101:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> led_s1_agent:cp_data
	...
	wire  [102:0] sw_s1_agent_rf_source_data;                                                         // SW_s1_agent:rf_source_data -> SW_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] sw_s1_agent_rsp_fifo_out_data;                                                      // SW_s1_agent_rsp_fifo:out_data -> SW_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> SW_s1_agent:cp_data
	...
	wire   [25:0] keys_s1_agent_m0_address;                                                           // Keys_s1_agent:m0_address -> Keys_s1_translator:uav_address
	...
	wire  [102:0] keys_s1_agent_rf_source_data;                                                       // Keys_s1_agent:rf_source_data -> Keys_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] keys_s1_agent_rsp_fifo_out_data;                                                    // Keys_s1_agent_rsp_fifo:out_data -> Keys_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> Keys_s1_agent:cp_data
	...
	wire  [101:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [101:0] sw_s1_agent_rp_data;                                                                // SW_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [101:0] keys_s1_agent_rp_data;                                                              // Keys_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [101:0] cmd_demux_src4_data;                                                                // cmd_demux:src4_data -> crosser:in_data
	...
	wire  [101:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_004:sink0_data
	...
	wire  [101:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_004:sink1_data
	...
	wire  [101:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> crosser_002:in_data
	...
	wire  [101:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink4_data
	...
	wire  [101:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> crosser_003:in_data
