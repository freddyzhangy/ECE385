...
module karatechamp_mm_interconnect_0_router_default_decode
  #(
...
module karatechamp_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    karatechamp_mm_interconnect_0_router_default_decode the_default_decode(
